"""ORM models for xiaoshuo agent persistence."""
...
class AgentRun(Base):
    ...
    source = Column(Text, nullable=False, default="xiaoshuo")
    ...
    __table_args__ = (
        UniqueConstraint("run_key", name="uq_xiaoshuo_agent_runs_run_key"),
        Index("idx_xiaoshuo_agent_runs_status", "status"),
        Index("idx_xiaoshuo_agent_runs_started_at", "started_at"),
    )
...
class AgentTask(Base):
    ...
    __table_args__ = (
        UniqueConstraint("task_key", name="uq_xiaoshuo_agent_tasks_task_key"),
        Index("idx_xiaoshuo_agent_tasks_status", "status"),
        Index("idx_xiaoshuo_agent_tasks_run_id", "run_id"),
    )
...
class AgentDecision(Base):
    ...
    __table_args__ = (
        UniqueConstraint("decision_key", name="uq_xiaoshuo_agent_decisions_decision_key"),
        Index("idx_xiaoshuo_agent_decisions_run_id", "run_id"),
        Index("idx_xiaoshuo_agent_decisions_task_id", "task_id"),
    )
...
class AgentArtifact(Base):
    ...
    __table_args__ = (
        UniqueConstraint("artifact_key", name="uq_xiaoshuo_agent_artifacts_artifact_key"),
        Index("idx_xiaoshuo_agent_artifacts_run_id", "run_id"),
        Index("idx_xiaoshuo_agent_artifacts_task_id", "task_id"),
        Index("idx_xiaoshuo_agent_artifacts_type", "artifact_type"),
    )
...
class AgentMetric(Base):
    ...
    __table_args__ = (
        UniqueConstraint("metric_key", name="uq_xiaoshuo_agent_metrics_metric_key"),
        Index("idx_xiaoshuo_agent_metrics_run_id", "run_id"),
        Index("idx_xiaoshuo_agent_metrics_name", "metric_name"),
    )
...
class AgentRecord(Base):
    ...
    __table_args__ = (
        UniqueConstraint("record_key", name="uq_xiaoshuo_agent_records_record_key"),
        Index("idx_xiaoshuo_agent_records_type", "record_type"),
    )
