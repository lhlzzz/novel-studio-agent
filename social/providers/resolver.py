...
ADAPTER_IMPORTS = {
    ...
    "xiaohongshu": "social.providers.xiaohongshu.adapter:XiaohongshuAdapter",
    "douyin": "social.providers.douyin.adapter:DouyinAdapter",
    "kuaishou": "social.providers.kuaishou.adapter:KuaishouAdapter",
    "xianyu": "social.providers.xianyu.adapter:XianyuAdapter",
}
...
PROVIDER_CAPABILITIES = {
    ...
    "xiaohongshu": {
        "image": {"api": True, "mcp": False},
        "video": {"api": True, "mcp": False},
        "handoff": {"api": True, "mcp": False},
        "publish": {"api": False, "mcp": False},
        "direct_publish": {"api": False, "mcp": False},
        "analytics": {"api": False, "mcp": False},
        "schedule": {"api": False, "mcp": False},
        "media_upload": {"api": False, "mcp": False},
        "text": {"api": True, "mcp": False},
        "carousel": {"api": True, "mcp": False},
        "listing": {"api": False, "mcp": False},
    },
    "douyin": {
        "video": {"api": True, "mcp": False},
        "image": {"api": True, "mcp": False},
    ...
    "xianyu": {
        "listing": {"api": True, "mcp": False},
        "listing_edit": {"api": True, "mcp": False},
        "listing_delete": {"api": True, "mcp": False},
        "media_upload": {"api": True, "mcp": False},
        "analytics": {"api": True, "mcp": False},
        "publish": {"api": False, "mcp": False},
        "video": {"api": False, "mcp": False},
        "image": {"api": True, "mcp": False},
        "schedule": {"api": False, "mcp": False},
        "handoff": {"api": False, "mcp": False},
    },
